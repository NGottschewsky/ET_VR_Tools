...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Calibration p_Calibration;
        ...
        public static SteamVR_Input_ActionSet_Calibration Calibration
        {
            get
            {
                return SteamVR_Actions.p_Calibration.GetCopy<SteamVR_Input_ActionSet_Calibration>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Calibration = ((SteamVR_Input_ActionSet_Calibration)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Calibration>("/actions/Calibration")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Calibration};
        }
    }
}
